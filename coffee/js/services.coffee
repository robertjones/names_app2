...
.factory('NameLists', ->
  ...
  internetCulture =
    "catName": "Internet Culture"
    "selected": false
    "names": [
      {"text":"Reddit Alien"},
      {"text":"Success Kid"},
      {"text":"Overly Attached Girlfriend"},
      {"text":"Old Spice Guy"},
      {"text":"Bad Luck Brian"},
      {"text":"Grumpy Cat"},
      ...
      {"text":"Good Guy Greg"},
      {"text":"Scumbag Steve"},
      {"text":"The Most Interesting Man In The World"},
      {"text":"Scumbag Stacy / Scumbag Girl"},
      {"text":"Sudden Clarity Clarence"},
      {"text":"College Freshman"},
      {"text":"Sheltering Suburban Mom"},
      {"text":"Little Darth Vader"},
      {"text":"Nyan Cat"},
      {"text":"Psy"},
      {"text":"Tay Zonday"},
      {"text":"Rebecca Black"},
      {"text":"Joseph Kony"},
      {"text":"Professor Randy Pausch"},
      {"text":"lonelygirl15"},
      {"text":"Rick Astley"},
      {"text":"Star Wars Kid"},
      {"text":"Chuck Norris"},
      {"text":"Salman Khan"},
      {"text":"Ted Williams / The Golden Voice"},
      {"text":"Honey Badger"},
      {"text":"Chuck Testa"},
      {"text":"Pepper Spray Cop"},
      {"text":"Lazy College Senior"},
      {"text":"George Watsky"},
      {"text":"Weird Al Yankovic"},
      {"text":"Condescending Willy Wonka"},
      {"text":"Perez Hilton"},
      {"text":"Danny MacAskill"},
      {"text":"Ken Block"},
      {"text":"Fenton"}
    ]
  o = [general, gameOfThrones, harryPotter, internetCulture]
  return o
)
